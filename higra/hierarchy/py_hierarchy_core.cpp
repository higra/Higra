...
void add_simplified_tree(M &m) {
    ...
    c.def("tree", [](class_t &self) -> hg::tree & { return self.tree; }, "The tree!", py::return_value_policy::reference_internal);
    c.def("node_map", [](class_t &self) -> hg::array_1d<hg::index_t> & { return self.node_map; }, "A node map array.", py::return_value_policy::reference_internal);
