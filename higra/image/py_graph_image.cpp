...
void py_init_graph_image(pybind11::module &m) {
    ...
    m.def("_get_4_adjacency_graph", [](const std::vector<hg::index_t> &v) {
              return hg::get_4_adjacency_graph(v);
          },
          "Create an explicit undirected 4 adjacency graph of the given shape.",
          py::arg("shape"));

    m.def("_get_8_adjacency_graph", [](const std::vector<hg::index_t> &v) {
              return hg::get_8_adjacency_graph(v);
          },
          "Create an explicit undirected 8 adjacency graph of the given shape.",
          py::arg("shape"));

    m.def("_get_4_adjacency_implicit_graph", [](const std::vector<hg::index_t> &v) {
            hg::embedding_grid_2d e(v);
            return hg::get_4_adjacency_implicit_graph(e);
          },
          "Create an explicit undirected 4 adjacency graph of the given shape (edges are not actually stored).",
          py::arg("shape"));

    m.def("_get_8_adjacency_implicit_graph", [](const std::vector<hg::index_t> &v) {
