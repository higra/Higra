...
BOOST_AUTO_TEST_SUITE(algo_tree);
    ...
    BOOST_AUTO_TEST_CASE(tree_isomorphism) {
        ...
        tree t1(array_1d<std::size_t>{5, 5, 6, 6, 7, 8, 7, 8, 8});
        tree t2(array_1d<std::size_t>{6, 6, 5, 5, 7, 7, 8, 8, 8});
        tree t3(array_1d<std::size_t>{7, 7, 5, 5, 6, 6, 8, 8, 8});
        ...
        tree t4(array_1d<std::size_t>{5, 5, 7, 6, 6, 8, 7, 8, 8});
