...
class TestConstrainedConnectivityHierarchy(unittest.TestCase):
    ...
    def test_alpha_omega_hierarchy(self):
        ...
        vertex_weights = np.asarray(((1, 2, 3),
                                     (5, 6, 5),
                                     (22, 21, 20)))
        tree, levels = hg.constrained_connectivity_hierarchy_alpha_omega(vertex_weights, graph)
    ...
    def test_strong_hierarchy(self):
        ...
        tree, levels = hg.constrained_connectivity_hierarchy_strong_connection(edge_weights, graph)
