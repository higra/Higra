...
public:
    ...
    T &operator[](ssize_t index) const { return operator()(index); }
...
public:
    ...
    operator[](ssize_t index) { return operator()(index); }
...
detail::vectorize_extractor(std::forward<Func>(f), (detail::function_signature_t < Func > *)
