...
namespace xsimd {
    ...
    inline batch<int64_t, 2>
    select(const batch_bool<int64_t, 2> &cond, const batch<int64_t, 2> &a, const batch<int64_t, 2> &b) {
